                        ...
                        <div class="widget">
                            ...
                            <ul class="cat">
                                <?php foreach ($all_publish_category as $publish_category) {
                                    ...
                                    <li><i class="icon-angle-right"></i><a href="<?php echo base_url();?>/welcome/category_blog/<?php echo $publish_category->id; ?>"><?php echo $publish_category->category_name; ?></a><span>&nbsp; <?php echo count($all_publish_blog);?></span></li>
                                    <?php
                                }
                                ?>
                            </ul>
